# =============================================================================
# Sensitivity (Hispanic) -- additionally adjusted for parental education.
...
saveRDS(edu, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/parental/output_all_hisp_LW_", out_date, ".RDS"))
...
saveRDS(edu.nc2, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/parental/output_nc_hisp_LW_", out_date, ".RDS"))
saveRDS(edu.cf2, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/parental/output_cf_hisp_LW_", out_date, ".RDS"))
...
saveRDS(edu, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/parental/output_all_hisp_GP_", out_date, ".RDS"))
...
saveRDS(edu.nc2, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/parental/output_nc_hisp_GP_", out_date, ".RDS"))
saveRDS(edu.cf2, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/parental/output_cf_hisp_GP_", out_date, ".RDS"))
