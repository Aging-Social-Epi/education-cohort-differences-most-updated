# =============================================================================
# Sensitivity (female) -- additionally adjusted for parental education.
# Runs LW + GP. Joint distribution samples (raceth, educat, pedu_cat) tuples.
# =============================================================================
...
raceth <- educat <- pedu_cat <- rep(NA_character_, sim_length)
...
sim1 <- as.data.frame(cbind(raceth, educat, pedu_cat), stringsAsFactors = FALSE)
sim2 <- cbind(sim, sim1)
...
saveRDS(edu, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/parental/output_all_female_LW_", out_date, ".RDS"))
...
saveRDS(edu.nc2, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/parental/output_nc_female_LW_", out_date, ".RDS"))
saveRDS(edu.cf2, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/parental/output_cf_female_LW_", out_date, ".RDS"))
...
saveRDS(edu, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/parental/output_all_female_GP_", out_date, ".RDS"))
...
saveRDS(edu.nc2, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/parental/output_nc_female_GP_", out_date, ".RDS"))
saveRDS(edu.cf2, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/parental/output_cf_female_GP_", out_date, ".RDS"))
