# =============================================================================
# Sensitivity (male) -- additionally adjusted for parental education.
...
saveRDS(edu, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/parental/output_all_male_LW_", out_date, ".RDS"))
...
saveRDS(edu.nc2, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/parental/output_nc_male_LW_", out_date, ".RDS"))
saveRDS(edu.cf2, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/parental/output_cf_male_LW_", out_date, ".RDS"))
...
saveRDS(edu, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/parental/output_all_male_GP_", out_date, ".RDS"))
...
saveRDS(edu.nc2, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/parental/output_nc_male_GP_", out_date, ".RDS"))
saveRDS(edu.cf2, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/parental/output_cf_male_GP_", out_date, ".RDS"))
