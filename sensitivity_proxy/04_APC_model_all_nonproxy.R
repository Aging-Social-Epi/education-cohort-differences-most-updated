# =============================================================================
#   Runs the primary cohort-difference decomposition restricted to
#   self-respondent person-years (excludes proxy interviews), for BOTH
#   dementia classification algorithms as co-primary.
#
# Outputs:
#   /Output/sen/proxy/output_all_LW_<date>.RDS       (LW raw bootstrap matrix)
#   /Output/sen/proxy/output_nc_all_LW_<date>.RDS    (LW collapsed nc)
#   /Output/sen/proxy/output_cf_all_LW_<date>.RDS    (LW collapsed cf)
#   /Output/sen/proxy/output_all_GP_<date>.RDS       (GP raw bootstrap matrix)
#   /Output/sen/proxy/output_nc_all_GP_<date>.RDS    (GP collapsed nc)
#   /Output/sen/proxy/output_cf_all_GP_<date>.RDS    (GP collapsed cf)
# =============================================================================
...
# Joint sampling: draw whole (gender, raceth, educat) tuples from each cohort's
# non-proxy empirical data
...
# Set factor levels to match APC_df
...
saveRDS(edu, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/proxy/output_all_LW_", out_date, ".RDS"))
...
saveRDS(edu.nc2, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/proxy/output_nc_all_LW_", out_date, ".RDS"))
saveRDS(edu.cf2, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/proxy/output_cf_all_LW_", out_date, ".RDS"))
...
saveRDS(edu, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/proxy/output_all_GP_", out_date, ".RDS"))
...
saveRDS(edu.nc2, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/proxy/output_nc_all_GP_", out_date, ".RDS"))
saveRDS(edu.cf2, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/proxy/output_cf_all_GP_", out_date, ".RDS"))
