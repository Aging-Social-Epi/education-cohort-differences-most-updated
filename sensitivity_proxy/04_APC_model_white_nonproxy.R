# =============================================================================
# Sensitivity analysis: NON-PROXY interviews only (non-Hispanic White stratum)
...
saveRDS(edu, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/proxy/output_all_white_LW_", out_date, ".RDS"))
...
saveRDS(edu.nc2, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/proxy/output_nc_white_LW_", out_date, ".RDS"))
saveRDS(edu.cf2, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/proxy/output_cf_white_LW_", out_date, ".RDS"))
...
saveRDS(edu, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/proxy/output_all_white_GP_", out_date, ".RDS"))
...
saveRDS(edu.nc2, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/proxy/output_nc_white_GP_", out_date, ".RDS"))
saveRDS(edu.cf2, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/proxy/output_cf_white_GP_", out_date, ".RDS"))
