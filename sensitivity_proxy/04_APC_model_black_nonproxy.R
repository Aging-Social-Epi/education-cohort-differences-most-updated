# =============================================================================
# Sensitivity analysis: NON-PROXY interviews only (non-Hispanic Black stratum)
...
APC_df <- readRDS(dataset_dir) %>%
  ...
  filter(raceth == "NH Black/African American")
...
saveRDS(edu, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/proxy/output_all_black_LW_", out_date, ".RDS"))
...
saveRDS(edu.nc2, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/proxy/output_nc_black_LW_", out_date, ".RDS"))
saveRDS(edu.cf2, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/proxy/output_cf_black_LW_", out_date, ".RDS"))
...
saveRDS(edu, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/proxy/output_all_black_GP_", out_date, ".RDS"))
...
saveRDS(edu.nc2, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/proxy/output_nc_black_GP_", out_date, ".RDS"))
saveRDS(edu.cf2, paste0("/restricted/project/gly-ukb/Ruijia/Output/sen/proxy/output_cf_black_GP_", out_date, ".RDS"))
