# =============================================================================
# Main analysis (female stratum): runs LW + GP sequentially.
# Same structure as 04_APC_model_male.R, filtered to female.
# =============================================================================
...
saveRDS(edu, paste0("/restricted/project/gly-ukb/Ruijia/Output/main/output_all_female_LW_", out_date, ".RDS"))
...
saveRDS(edu.nc2, paste0("/restricted/project/gly-ukb/Ruijia/Output/main/output_nc_female_LW_", out_date, ".RDS"))
saveRDS(edu.cf2, paste0("/restricted/project/gly-ukb/Ruijia/Output/main/output_cf_female_LW_", out_date, ".RDS"))
...
saveRDS(edu, paste0("/restricted/project/gly-ukb/Ruijia/Output/main/output_all_female_GP_", out_date, ".RDS"))
...
saveRDS(edu.nc2, paste0("/restricted/project/gly-ukb/Ruijia/Output/main/output_nc_female_GP_", out_date, ".RDS"))
saveRDS(edu.cf2, paste0("/restricted/project/gly-ukb/Ruijia/Output/main/output_cf_female_GP_", out_date, ".RDS"))
