# =============================================================================
# Main analysis (male stratum): runs LW + GP sequentially.
# Filtered to male respondents. Joint distribution samples (raceth, educat)
# tuples (gender is fixed). Passes strata = "gender" to mediation_analysis().
# =============================================================================
...
# Joint sampling: gender-stratified, so sample (raceth, educat) only
...
saveRDS(edu, paste0("/restricted/project/gly-ukb/Ruijia/Output/main/output_all_male_LW_", out_date, ".RDS"))
...
saveRDS(edu.nc2, paste0("/restricted/project/gly-ukb/Ruijia/Output/main/output_nc_male_LW_", out_date, ".RDS"))
saveRDS(edu.cf2, paste0("/restricted/project/gly-ukb/Ruijia/Output/main/output_cf_male_LW_", out_date, ".RDS"))
...
saveRDS(edu, paste0("/restricted/project/gly-ukb/Ruijia/Output/main/output_all_male_GP_", out_date, ".RDS"))
...
saveRDS(edu.nc2, paste0("/restricted/project/gly-ukb/Ruijia/Output/main/output_nc_male_GP_", out_date, ".RDS"))
saveRDS(edu.cf2, paste0("/restricted/project/gly-ukb/Ruijia/Output/main/output_cf_male_GP_", out_date, ".RDS"))
