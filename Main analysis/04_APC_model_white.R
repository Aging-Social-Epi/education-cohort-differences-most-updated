# =============================================================================
# Main analysis (non-Hispanic White stratum): runs LW + GP sequentially.
# Filtered to NH White respondents. Joint distribution samples (gender, educat)
# =============================================================================
...
# Joint sampling: race-stratified, so sample (gender, educat) only
gender <- educat <- rep(NA_character_, sim_length)
...
sim1 <- as.data.frame(cbind(gender, educat), stringsAsFactors = FALSE)
...
saveRDS(edu, paste0("/restricted/project/gly-ukb/Ruijia/Output/main/output_all_white_LW_", out_date, ".RDS"))
...
saveRDS(edu.nc2, paste0("/restricted/project/gly-ukb/Ruijia/Output/main/output_nc_white_LW_", out_date, ".RDS"))
saveRDS(edu.cf2, paste0("/restricted/project/gly-ukb/Ruijia/Output/main/output_cf_white_LW_", out_date, ".RDS"))
...
saveRDS(edu, paste0("/restricted/project/gly-ukb/Ruijia/Output/main/output_all_white_GP_", out_date, ".RDS"))
...
saveRDS(edu.nc2, paste0("/restricted/project/gly-ukb/Ruijia/Output/main/output_nc_white_GP_", out_date, ".RDS"))
saveRDS(edu.cf2, paste0("/restricted/project/gly-ukb/Ruijia/Output/main/output_cf_white_GP_", out_date, ".RDS"))
