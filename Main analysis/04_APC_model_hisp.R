# =============================================================================
# Main analysis (Hispanic stratum): runs LW + GP sequentially.
# Same structure as 04_APC_model_white.R, filtered to Hispanic.
# =============================================================================
...
saveRDS(edu, paste0("/restricted/project/gly-ukb/Ruijia/Output/main/output_all_hisp_LW_", out_date, ".RDS"))
...
saveRDS(edu.nc2, paste0("/restricted/project/gly-ukb/Ruijia/Output/main/output_nc_hisp_LW_", out_date, ".RDS"))
saveRDS(edu.cf2, paste0("/restricted/project/gly-ukb/Ruijia/Output/main/output_cf_hisp_LW_", out_date, ".RDS"))
...
saveRDS(edu, paste0("/restricted/project/gly-ukb/Ruijia/Output/main/output_all_hisp_GP_", out_date, ".RDS"))
...
saveRDS(edu.nc2, paste0("/restricted/project/gly-ukb/Ruijia/Output/main/output_nc_hisp_GP_", out_date, ".RDS"))
saveRDS(edu.cf2, paste0("/restricted/project/gly-ukb/Ruijia/Output/main/output_cf_hisp_GP_", out_date, ".RDS"))
